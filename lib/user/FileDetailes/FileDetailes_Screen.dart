...
class _FileDetailsScreenState extends State<FileDetailsScreen>
  ...
  Widget build(BuildContext context) {
    ...
    MyBookedFilesController _MyBookedFilesController =
    ...
    FileTracingUserController fileTracingUserController =
                ...
                child: Column(
                  children: [
                    Align(
                      ...
                      child: Tooltip(
                        message: 'Download file report',
                        // Tooltip for the report icon
                        child: IconButton(
                          icon: Icon(
                          ...
                          onPressed: () {
                            downloadReportController.downloadReportForFile(
                                file.id, folderId);
                          },
                        ),
                      ),
                              ...
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    file.bookedUser == null
                                        ? Tooltip(
                                            message: 'Check in this file',
                                            // Tooltip for Check In button
                                            child: ElevatedButton(
                                              onPressed: () {
                                                _MyBookedFilesController
                                                    .fileCheckIn(file.id);
                                              },
                                              child: Text("Check In"),
                            ...
                            children: [
                              ...
                              file.bookedUser == null
                                  ? Tooltip(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () {
                                          _MyBookedFilesController.fileCheckIn(
                                              file.id);
                                        },
                                        child: Text("Check In"),
                                        style: ElevatedButton.styleFrom(
                ...
                children: [
                  ...
                  Obx(() {
                    ...
                    return ListView.builder(
                      itemCount:
                          fileTracingUserController.fileTracingList.length,
                      itemBuilder: (context, index) {
                        final fileTracing =
                            fileTracingUserController.fileTracingList[index];
                        return Card(
                  ...
                  Center(
                    child: Obx(() {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final backup =
                              fileTracingUserController.backupList[index];
                          return Card(
                            margin: const EdgeInsets.symmetric(
                                vertical: 8.0, horizontal: 16.0),
                            shape: RoundedRectangleBorder(
